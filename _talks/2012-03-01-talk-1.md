...
[(a) Synthetic scene with scanned point cloud overlayed (b) Point cloud with
distance color coded from blue(least) to red(highest)]https://github.com/jasorsi13/jasorsi.github.io/blob/master/paper_img/1.PNG
